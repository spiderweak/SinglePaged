...
bg: jeudi
color : white
border-color: vendredi
fa-icon: rocket
---

<div class="section-lines section-top section-left"></div>
{% for activity in site.data.agenda.jeudi %}
  {% capture thecycle %}{% cycle 'even', 'odd' %}{% endcapture %}
  {% if thecycle == 'odd' %}
  {% if activity == site.data.agenda.jeudi.last %}
  ...
  {% endif %}
    <div class="row activity-info-wrapper valign-wrapper">
      ...
      <div class="col m9 activity-info">
        ...
        <a class="waves-effect waves-light btn bg-{{ page.border-color }}" href="{{ activity.typeform }}" target="blank">S'inscrire</a>
        {% endif %}
        {% if activity.funding %}
        <a class="waves-effect waves-light btn bg-{{ page.border-color }}" href="{{ activity.funding }}" target="blank">Donnez</a>
        {% endif %}
      </div>
    </div>
  </div>
